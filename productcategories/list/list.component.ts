...
export class ListComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  exampleDatabase: ProductcategoriesService | null;
  dataSource: ProductcategoriesDataSource | null;
  selection = new SelectionModel<Productcategories>(true, []);
  index: number;
  id: number;
  ...
  constructor(
    ...
    public productcateg: ProductcategoriesService,
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<Productcategories>(true, []);
    });
    this.showNotification(
      "snackbar-danger",
  ...
  public loadData() {
    this.exampleDatabase = new ProductcategoriesService(this.api);
    this.dataSource = new ProductcategoriesDataSource(
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: Productcategories) {
...
export class ProductcategoriesDataSource extends DataSource<Productcategories> {
  ...
  filteredData: Productcategories[] = [];
  renderedData: Productcategories[] = [];
  constructor(
  ...
  connect(): Observable<Productcategories[]> {
  ...
  sortData(data: Productcategories[]): Productcategories[] {
